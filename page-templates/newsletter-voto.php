<?php
/**
 * Template Name: Newsletter Valor del Voto
 *
 * Página de Newsletter del valor del voto
 *
		...
		<div class="components">
			...
			<div class="col-lg-8">
				<div class="component-newsletter">
					<div class="ribbon">
						<img src="<?=IMAGESPATH;?>/custom/valor-del-voto.png" alt="premium" title="premium" width="150" height="150">
					</div>
					<div class="form">
						<span>Suscríbete a nuestro newsletter especial para recibir lo más relevante de las próximas elecciones.</span>
						<div id="mc_embed_signup">
							<form action="https://reporteindigo.us5.list-manage.com/subscribe/post?u=98276b176d550186c74177fef&amp;id=6e22911b7e" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
								...
								<div class="snd">
									...
									<div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_98276b176d550186c74177fef_6e22911b7e" tabindex="-1" value=""></div>
