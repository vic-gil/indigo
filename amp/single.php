...
<?php $this->load_parts( [ 'sidebar' ] ); ?>

<article class="amp-wp-article">
	<header class="amp-wp-article-header">
		<h2 class="amp-wp-tema"><?php echo $this->get( 'tema' )['amp_html'];?></h2>
		 ...
		 */
		$this->load_parts( apply_filters( 'amp_post_article_header_meta', [] ) );
		?>
	</header>

	<?php
	if( ! empty( $this->get( 'jwplayer' ) ) ) {
		$this->load_parts( [ 'jwplayer-videos' ] );
	} else {
		$this->load_parts( [ 'featured-image' ] );
	}
	?>
	<div class="amp-wp-extra">
	<?php
	$this->load_parts( [ 'meta-author-date' ] );
	$this->load_parts( [ 'meta-share' ] );
	?>
	</div>
	...
	<footer class="amp-wp-article-footer">
		 ...
		 * @param string[] Templates to load.
		 */
		$this->load_parts( apply_filters( 'amp_post_article_footer_meta', [ 'featured-posts' ] ) );
		?>
	</footer>
</article>
