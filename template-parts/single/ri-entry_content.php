...
<section class="entry-content">
	<div class="components">
		<div class="entry-info">
			...
			<button type="button" onclick="utilerias.share(this);" data-link="<?=get_the_permalink();?>" data-title="<?=rawurlencode( get_the_title() );?>" class="fas fa-share-alt" aria-label="comparte" ></button>
		</div>
