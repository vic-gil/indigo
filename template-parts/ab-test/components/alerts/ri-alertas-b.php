<?php
/**
 * Parte de plantilla para mostrar alertas de último momento con estilo B
 *
...
<div class="componente-alertas">
	<div class="wrap">
		<picture>
			...
			<img src="<?=get_template_directory_uri() . '/assets/images/components/alertas/uh-short.svg'?>" type="image/svg+xml" alt="Logo último momento" />
		</picture>
